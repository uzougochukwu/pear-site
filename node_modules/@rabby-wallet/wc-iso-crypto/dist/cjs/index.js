...
function generateKey(length) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const result = (0, wc_utils_1.convertBufferToArrayBuffer)(encoding.arrayToBuffer(bytes));
        return result;
    });
}
...
function encrypt(data, key, providedIv) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const _key = encoding.bufferToArray((0, wc_utils_1.convertArrayBufferToBuffer)(key));
        const ivArrayBuffer = providedIv || (yield generateKey(128));
        const iv = encoding.bufferToArray((0, wc_utils_1.convertArrayBufferToBuffer)(ivArrayBuffer));
