...
const wc_utils_1 = require("@rabby-wallet/wc-utils");
...
function getWebSocketUrl(_url, protocol, version) {
    ...
    const params = (0, wc_utils_1.isBrowser)()
        ? {
            protocol,
            version,
            env: "browser",
            host: ((_a = (0, wc_utils_1.getLocation)()) === null || _a === void 0 ? void 0 : _a.host) || "",
        }
        : {
            protocol,
            version,
            env: ((_b = (0, wc_utils_1.detectEnv)()) === null || _b === void 0 ? void 0 : _b.name) || "",
        };
    const queryString = (0, wc_utils_1.appendToQueryString)((0, wc_utils_1.getQueryString)(splitUrl[1] || ""), params);
